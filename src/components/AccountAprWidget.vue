  ...
  <div class="account-apr-widget-component">
    ...
    <div class="bull-meter-section">
      <template v-if="bullScore !== undefined && bullScore !== null">
        ...
        <InfoIcon :size="16" class="bull-meter-section__info-icon" :tooltip="{content: 'The percentage change of your collateral value if all volatile assets appreciate with 100%; your bullishness on the cryptomarket. This Feature is currently in <b>Beta</b>, and excludes liquidation effects.'}"></InfoIcon>
      </template>
      <div v-else>
        <vue-loaders-ball-beat color="#A6A3FF" scale="0.5"></vue-loaders-ball-beat>
      </div>
